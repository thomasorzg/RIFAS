...
(function (window, $, undefined) {
    var pluginName = 'datepicker',
        ...
        defaults = {
            ...
            showEvent: 'focus',
            autoClose: true,      //Niemand's Edit (original: false)
	...
	Datepicker.language = {
		es: {
			...
			months: ['Enero','Febrero','Marzo','Abril','Mayo','Junio', 'Julo','Augsto','Septiembre','Octubre','Noviembre','Diciembre'],
			monthsShort: ['Ene', 'Feb', 'Mar', 'Abr', 'May', 'Jun', 'Jul', 'Ago', 'Sep', 'Oct', 'Nov', 'Dic'],
			today: 'Hoy',
			clear: 'Limpiar',
			dateFormat: 'dd-mm-yyyy', //Niemand's Edit (original: 'mm/dd/yy',)
			firstDay: 0
		}
	};
